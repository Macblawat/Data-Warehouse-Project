...
SELECT DISTINCT
	...
	ws.SubjectID,
	  (SELECT  TimeID
     FROM warehouse_imp.dbo.Time AS t
...
JOIN warehouse_imp.dbo.Subject AS ws ON us.SubjectName = ws.Subjectname
...
JOIN warehouse_imp.dbo.Major AS wm ON um.MajorName = wm.Majorname
